...
100+ other open source hackers. It really opened my eyes to the scale of
security threats in the wild and the complexity of dealing with them.

Big thanks to the security team at [GitHub](https://github.com/) for providing
...
![Selenium GitHub SOSF](/assets/img/posts/2026-02-17_selenium_github_sosf.jpg){: w="800" }
